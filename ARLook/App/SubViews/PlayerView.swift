...
struct PlayerView: UIViewRepresentable {
  ...
  /// A Boolean value that indicates whether the video contains transparent pixels.
  ...
  private static let videoSize = CGSize(width: 1280, height: 1080).applying(
      ...
      applyingCIFiltersWithHandler: { request in
        ...
        if isStacked {
          ...
          let sourceRect = CGRect(
            origin: .zero, size: CGSize(width: videoSize.width, height: videoSize.height))
